...
{
    private const string ModuleName = IdentityConstants.ModuleName;
            ...
            IDbTransaction transaction)
    {
        ...
        string sql =
            $"""
             ...
             FROM {IdentityConstants.Schema}.outbox_messages
            ...
            Exception? exception)
    {
        ...
        const string sql =
            $"""
            UPDATE {IdentityConstants.Schema}.outbox_messages
